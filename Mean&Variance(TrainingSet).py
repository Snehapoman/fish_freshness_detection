...
for subfolder in subfolders:
    ...
    print(f"\n{subfolder.capitalize()} Fish Samples:")
    print("Mean \t Variance")
    print("-------------------------")

    # Print mean intensity and variance values
    for mean_intensity, variance in zip(mean_intensities, variances):
        print(f"{mean_intensity:.2f} \t {variance:.2f}")
